...
from train_ppo.ppo_bidding_env_subset import PpoBiddingEnv
...
class PPO:
    ...
    def __init__(
        ...
        save_path: str = "strategy_train_env/saved_model/ppo_against_iql_onlinelp_1e7",
...
if __name__ == "__main__":
    ...
    agent = PPO(
        ...
        update_freq=4,
        max_ep_len=48,
        save_path="saved_model/ppo_against_iql_onlinelp_1e7",
